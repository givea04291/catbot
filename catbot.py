...
async def on_message(message):
    ...
    if message.content.endswith(f'{prefix}시간'):
    ...
    if message.content.endswith(f'{prefix2}가감'):
    ...
    if message.content.endswith(f'{prefix2}가감법'):
